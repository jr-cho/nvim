...
return {
	...
	-- Before everything. The start screen links its highlights to groups this
	-- defines, and a colorscheme loaded late repaints over other plugins.
	priority = 1000,
	lazy = false,
	...
	config = function()
		require("onedark").setup({
			...
			-- The two overrides the previous config carried. The line number
			-- grey is onedark's own, dim enough that the numbers do not compete
			-- with the code. The cursor line number is onedark's purple, which
			-- marks the current line at a glance.
			highlights = {
				LineNr = { fg = "$grey" },
